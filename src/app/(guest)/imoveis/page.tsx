          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
            ...
            <div>
              <div className="flex items-center gap-3 mb-4">
                ...
                />
                <div>
                  <p className="font-bold text-white tracking-wide">Reservas Ita</p>
                  <p className="text-xs" style={{ color: "rgba(255,255,255,0.4)" }}>Temporadas Premium · Itanhaém</p>
                </div>
              </div>
            ...
            <div>
              ...
              <div className="space-y-3 text-sm" style={{ color: "rgba(255,255,255,0.5)" }}>
                <a href="https://instagram.com/reservas.ita" target="_blank" rel="noopener noreferrer"
                  className="flex items-center gap-2 hover:text-white transition-colors">
