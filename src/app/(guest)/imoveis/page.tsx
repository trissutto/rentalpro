      ...
      <footer className="py-16 px-4" style={{ background: "#0a0a0a", borderTop: "1px solid rgba(255,255,255,0.08)" }}>
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
            ...
            <div>
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <p className="font-bold text-white">Villa Mare</p>
            ...
            <div>
              ...
              <div className="space-y-3 text-sm" style={{ color: "rgba(255,255,255,0.5)" }}>
                ...
                <a href="mailto:contato@villamare.com.br"
                  className="flex items-center gap-2 hover:text-white transition-colors">
                  <span>✉️</span> contato@villamare.com.br
                </a>
            ...
            <div>
              ...
              <div className="space-y-3 text-sm" style={{ color: "rgba(255,255,255,0.5)" }}>
                <a href="https://instagram.com/villamare" target="_blank" rel="noopener noreferrer"
                  className="flex items-center gap-2 hover:text-white transition-colors">
          ...
          <div className="pt-8 text-center text-xs" style={{ borderTop: "1px solid rgba(255,255,255,0.06)", color: "rgba(255,255,255,0.3)" }}>
            &copy; {new Date().getFullYear()} Villa Mare &middot; Todos os direitos reservados
          </div>
        </div>
      </footer>
