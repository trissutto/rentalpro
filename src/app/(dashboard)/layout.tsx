    ...
    <>
      ...
      <div className="px-5 pt-6 pb-4">
        <div className="flex items-center gap-3">
          ...
          />
          <div>
            <p className="font-bold text-white text-sm tracking-wide">Reservas Ita</p>
            <p className="text-[10px] text-slate-500 tracking-wider uppercase">Central de Reservas</p>
          </div>
        </div>
      </div>
        ...
        <header className="sticky top-0 z-20 bg-white/80 backdrop-blur-sm border-b border-slate-200 px-4 py-3 md:hidden flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2">
              ...
              />
              <span className="font-bold text-slate-900 text-sm">Reservas Ita</span>
            </div>
          </div>
